...
public class ItemVipBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.pet_lay, 13);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final android.widget.LinearLayout petLay;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.vip.VipItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public ItemVipBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.petLay = (android.widget.LinearLayout) bindings[13];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.petproject.viewmodel.vip.VipItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.petproject.viewmodel.vip.VipItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.vip.VipItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.petproject.viewmodel.vip.VipItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.petproject.viewmodel.vip.VipItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.vip.VipItemViewModel itemViewModel = mItemViewModel;
    ...
    public static ItemVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemVipBinding>inflate(inflater, ys.app.petproject.R.layout.item_vip, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.item_vip, null, false), bindingComponent);
    }
    @NonNull
