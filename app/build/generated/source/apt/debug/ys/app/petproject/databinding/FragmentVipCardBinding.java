...
public class FragmentVipCardBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.vip.VipCardFragmentViewModel value) {
            this.value = value;
    ...
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentVipCardBinding>inflate(inflater, ys.app.petproject.R.layout.fragment_vip_card, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.fragment_vip_card, null, false), bindingComponent);
    }
    @NonNull
