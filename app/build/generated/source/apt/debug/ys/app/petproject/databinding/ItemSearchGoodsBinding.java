...
public class ItemSearchGoodsBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.SearchGoodsItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.petproject.viewmodel.SearchGoodsItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.petproject.viewmodel.SearchGoodsItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.SearchGoodsItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.petproject.viewmodel.SearchGoodsItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.petproject.viewmodel.SearchGoodsItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.SearchGoodsItemViewModel itemViewModel = mItemViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.SearchGoodsItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.SearchGoodsItemViewModel value) {
            this.value = value;
    ...
    public static ItemSearchGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemSearchGoodsBinding>inflate(inflater, ys.app.petproject.R.layout.item_search_goods, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemSearchGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.item_search_goods, null, false), bindingComponent);
    }
    @NonNull
