...
public class ItemPayMethodStatisticsBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.PayMethodStatisticsItemViewModel itemViewModel = mItemViewModel;
        java.lang.String stringValueOfItemViewModelModelTotalAmt = null;
        ys.app.petproject.model.StatisticsDataInfo.PayMethodListBean itemViewModelModel = null;
    ...
    public static ItemPayMethodStatisticsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemPayMethodStatisticsBinding>inflate(inflater, ys.app.petproject.R.layout.item_paymethod_statistics, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemPayMethodStatisticsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.item_paymethod_statistics, null, false), bindingComponent);
    }
    @NonNull
