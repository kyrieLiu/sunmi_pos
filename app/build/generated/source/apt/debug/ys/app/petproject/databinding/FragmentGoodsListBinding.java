...
public class FragmentGoodsListBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.GoodsListViewModel mViewModel;
    // values
    // listeners
    private OnClickListenerImpl mViewModelOnClickNetWorkErrorAndroidViewViewOnClickListener;
    // Inverse Binding Event Handlers

    public FragmentGoodsListBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.petproject.viewmodel.GoodsListViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.petproject.viewmodel.GoodsListViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.GoodsListViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.petproject.viewmodel.GoodsListViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.petproject.viewmodel.GoodsListViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.GoodsListViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.GoodsListViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.GoodsListViewModel value) {
            this.value = value;
    ...
    @NonNull
    public static FragmentGoodsListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentGoodsListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentGoodsListBinding>inflate(inflater, ys.app.petproject.R.layout.fragment_goods_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static FragmentGoodsListBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentGoodsListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.fragment_goods_list, null, false), bindingComponent);
    }
    @NonNull
    public static FragmentGoodsListBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentGoodsListBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/fragment_goods_list_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new FragmentGoodsListBinding(bindingComponent, view);
    }
    /* flag mapping
