...
public class ActivityAppointmentMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.appointment.AppointmentMainViewModel value) {
            this.value = value;
    ...
    public static ActivityAppointmentMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAppointmentMainBinding>inflate(inflater, ys.app.petproject.R.layout.activity_appointment_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAppointmentMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.activity_appointment_main, null, false), bindingComponent);
    }
    @NonNull
