...
public class ActivityAddEmployeeBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.manage.AddEmployeeViewModel mViewModel;
    // values
    // listeners
    ...
    public ActivityAddEmployeeBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.scrollView = (ys.app.petproject.widget.MyNestedScrollView) bindings[3];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.petproject.viewmodel.manage.AddEmployeeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.petproject.viewmodel.manage.AddEmployeeViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.manage.AddEmployeeViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModel((ys.app.petproject.viewmodel.manage.AddEmployeeViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModel(ys.app.petproject.viewmodel.manage.AddEmployeeViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.manage.AddEmployeeViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.manage.AddEmployeeViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.manage.AddEmployeeViewModel value) {
            this.value = value;
    ...
    public static ActivityAddEmployeeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAddEmployeeBinding>inflate(inflater, ys.app.petproject.R.layout.activity_add_employee, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAddEmployeeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.activity_add_employee, null, false), bindingComponent);
    }
    @NonNull
