...
public class AllotListActivityBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.AllotShopListModel mViewModel;
    @Nullable
    ...
    public AllotListActivityBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.recyclerView = (ys.app.petproject.widget.wrapperRecylerView.IRecyclerView) bindings[6];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.petproject.viewmodel.AllotShopListModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.petproject.viewmodel.AllotShopListModel ViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.AllotShopListModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.petproject.viewmodel.AllotShopListModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.petproject.viewmodel.AllotShopListModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.AllotShopListModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.okBtn.setOnClickListener(mCallback75);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.AllotShopListModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.AllotShopListModel value) {
            this.value = value;
    ...
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<AllotListActivityBinding>inflate(inflater, ys.app.petproject.R.layout.activity_allot_shop_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.activity_allot_shop_list, null, false), bindingComponent);
    }
    @NonNull
