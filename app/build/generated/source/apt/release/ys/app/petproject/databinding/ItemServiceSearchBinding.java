...
public class ItemServiceSearchBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.petproject.viewmodel.ServiceSearchItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.petproject.viewmodel.ServiceSearchItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.petproject.viewmodel.ServiceSearchItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.petproject.viewmodel.ServiceSearchItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.petproject.viewmodel.ServiceSearchItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.petproject.viewmodel.ServiceSearchItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.petproject.viewmodel.ServiceSearchItemViewModel itemViewModel = mItemViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.petproject.viewmodel.ServiceSearchItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.petproject.viewmodel.ServiceSearchItemViewModel value) {
            this.value = value;
    ...
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemServiceSearchBinding>inflate(inflater, ys.app.petproject.R.layout.item_service_search, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.petproject.R.layout.item_service_search, null, false), bindingComponent);
    }
    @NonNull
