...
public class InitDataUtils {
    ...
    public InitDataUtils getGoodsTypeHttp() {
        Logger.e("InitDataUtils ------->>>> getGoodsTypeHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (userList != null && !userList.isEmpty()) {
                ...
                Logger.e("getGoodsTypeHttp ------->>>> 间隔时间 = "+ intervalTime);
    ...
    public InitDataUtils getServiceTypeHttp() {
        Logger.e("InitDataUtils ------->>>> getServiceTypeHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                long time = nowTime - lastTime;
                long intervalTime = time / mi;//分钟
                Logger.e("getServiceTypeHttp ------->>>> 间隔时间 = "+ intervalTime);
                if (intervalTime > sIntervalTime) {//大于60分钟
                    loadServiceTypeHttp();
                }
            } else {
    ...
    public InitDataUtils getVipCardHttp() {
        Logger.e("InitDataUtils ------->>>> getVipCardHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                long time = nowTime - lastTime;
                long intervalTime = time / mi;//分钟
                Logger.e("getVipCardHttp ------->>>> 间隔时间 = "+ intervalTime);
                if (intervalTime > sIntervalTime) {//大于60分钟
                    loadVipCardHttp();
                }
            } else {
    ...
    public InitDataUtils getAnimalTypeHttp() {
        Logger.e("InitDataUtils ------->>>> getAnimalTypeHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                long time = nowTime - lastTime;
                long intervalTime = time / mi;//分钟
                Logger.e("getAnimalTypeHttp ------->>>> 间隔时间 = "+ intervalTime);
                if (intervalTime > sIntervalTime) {//大于60分钟
                    loadAnimalTypeHttp();
                }
            } else {
    ...
    public InitDataUtils getEmployeeListHttp() {
        Logger.e("InitDataUtils ------->>>> getEmployeeListHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                long time = nowTime - lastTime;
                long intervalTime = time / mi;//分钟
                Logger.e("getEmployeeListHttp ------->>>> 间隔时间 = "+ intervalTime);
                if (intervalTime > sIntervalTime) {//大于60分钟
    ...
    public InitDataUtils getBackReasonHttp() {
        Logger.e("InitDataUtils ------->>>> getBackReasonHttp");
        long nowTime;
        long lastTime;
        ...
        if (dao != null) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                long time = nowTime - lastTime;
                long intervalTime = time / mi;//分钟
                Logger.e("getBackReasonHttp ------->>>> 间隔时间 = "+ intervalTime);
                if (intervalTime > sIntervalTime) {//大于60分钟
                    loadBackReasonHttp();
                }
            } else {
