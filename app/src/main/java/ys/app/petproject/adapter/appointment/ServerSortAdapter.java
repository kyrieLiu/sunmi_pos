...
public class ServerSortAdapter extends BaseAdapter implements SectionIndexer {
	private List<ServiceInfo> list = null;
	private Context mContext;

	public ServerSortAdapter(Context mContext, List<ServiceInfo> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final ServiceInfo mContent = list.get(position);
		if (view == null) {
