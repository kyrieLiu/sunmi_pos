...
import ys.app.petproject.databinding.ItemVipCardBinding;
import ys.app.petproject.model.VipCardInfo;
import ys.app.petproject.viewmodel.manage.VipCardItemViewModel;
    ...
    public static class MyViewHolder  extends RecyclerView.ViewHolder {
        ...
        public void bind(final OnItemClickListener listener, VipCardInfo itemModle, final int position, BaseActivity mBaseActivity, int showType,int classification) {
            ...
            if (mBinding.getItemViewModel() == null) {
                itemViewModel = new VipCardItemViewModel(position,itemModle, mBaseActivity,showType,classification);
