            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.rb_item_hairdressing_true:
                        if ("毛量".equals(info)) {
                            if (filterList.contains("毛量少")) filterList.remove("毛量少");
                            filterList.add(info + "多");
                        } else if ("毛质".equals(info)) {
                            if (filterList.contains("毛质硬")) filterList.remove("毛质硬");
                            filterList.add(info + "软");
                        } else {
                            filterList.add(info);
                        }
                        break;
                    case R.id.rb_item_hairdressing_false:
                        if ("毛量".equals(info)) {
                            if (filterList.contains("毛量多")) filterList.remove("毛量多");
                            filterList.add(info + "少");
                        } else if ("毛质".equals(info)) {
                            if (filterList.contains("毛质软")) filterList.remove("毛质软");
                            filterList.add(info + "硬");
                        } else if (filterList.contains(info)) {
