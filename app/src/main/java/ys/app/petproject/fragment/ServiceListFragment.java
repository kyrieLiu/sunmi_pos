...
import ys.app.petproject.viewmodel.ServiceListViewModel;

/**
 * Created by aaa on 2017/7/13.
 */

public class ServiceListFragment extends ViewPagerFragment {
...
//            boolean isAddOrder = arguments.getBoolean(Constants.intent_boolean, false);
            ...
            mViewModel = new ServiceListViewModel(this, binding, info, searchFromIntent);
