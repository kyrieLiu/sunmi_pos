...
public class OrderQueryResult implements Serializable{
     ...
     * originalErrorCode：400
     * originalErrorDesc：平台方错误 >> 交易不存在[-300]
     */
    ...
    public String getOriginalErrorDesc() {
        return originalErrorDesc;
    }

    public void setOriginalErrorDesc(String originalErrorDesc) {
        this.originalErrorDesc = originalErrorDesc;
    }
