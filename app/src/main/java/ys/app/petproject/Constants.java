...
public class Constants {
    ...
    public static final String base_url = "http://101.200.196.107:7080/";//正式服务器
    //public static final String base_url = "http://101.200.196.107:7890/";//测试服务器
    //public static final String base_url = "http://192.168.10.59:8080/";//本地服务器
    public static final String base_other_url = "http://101.200.196.107:7890/";//负载均衡服务器
...
//    public static final String base_sand_url = "https://scan.sandgate.cn:20042/sandpay/api/";       // 杉德测试环境
    ...
    public static final int type_gua_dan_success = 307;
    public static final int type_jie_zhang_success = 308;
    ...
    public static final int type_delete_commitOrder_db = 309;
    ...
    public static final int type_int_weixin_pay = 0;
    public static final int type_int_zhifubao_pay = 1;
    public static final int type_int_yinhangka_pay = 2;
    public static final int type_int_xianjin_pay = 3;
    public static final int type_int_scan_weixin_pay =5;
    public static final int type_int_scan_zhifubao_pay=6;
    public static final int type_int_boss_weixin_pay=7;
    public static final int type_int_boss_zhifubao_pay=8;
    ...
    public static final String confirm_type_info = "confirm_type_info";//会员正常销售价
    public static final String confirm_vip_info = "confirm_vip_info";//会员会员价销售
    ...
    public static final String ConfirmCheckout_PendingOrder_suc = "ConfirmCheckout_PendingOrder_suc";
