...
import ys.app.petproject.adapter.appointment.AppointmentAdapter;
...
public class AppointmentListModel extends BaseFragmentViewModel{
    ...
    private String date;
    public AppointmentListModel(AppointmentAreadyFragment fragment,int intentFrom,String date,IRecyclerView recyclerView){
    ...
    public void initAppointment(){
        ...
        adapter=new AppointmentAdapter(fragment);
        if (intentFrom==1){
