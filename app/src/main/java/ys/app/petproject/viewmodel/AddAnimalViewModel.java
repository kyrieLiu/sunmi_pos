...
public class AddAnimalViewModel extends BaseActivityViewModel {
    ...
    public ObservableInt selectWaiquImg = new ObservableInt(R.mipmap.arrow_down_grey);
    public ObservableInt selectBreedImg = new ObservableInt(R.mipmap.arrow_down_grey);
    public ObservableInt selectQuchongImg = new ObservableInt(R.mipmap.arrow_down_grey);
    ...
    public ObservableInt selectYimiaoImg = new ObservableInt(R.mipmap.arrow_down_grey);
    public ObservableInt selectYimiaoPeriodImg = new ObservableInt(R.mipmap.arrow_down_grey);
    ...
    private void addAnimalHttp() {
        ...
        if (!StringUtils.isEmptyOrWhitespace(isSkin.get())){
            params.put("isSkin",skinSelect.getType());

        }
        if (!StringUtils.isEmptyOrWhitespace(isBite.get())){
