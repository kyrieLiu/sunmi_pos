...
public class GoodsItemViewModel extends BaseObservable {
    ...
    public GoodsItemViewModel(GoodInfo model, Context context, boolean promotion,boolean ruku,boolean chuku) {
        this.model = model;
        this.mContext = context;
        promotionSetting.set(promotion);
        this.ruku.set(ruku);
        this.chuku.set(chuku);
        setPrice(model);
        setRealMoneyColor();
    }
    ...
    public void setModel(GoodInfo model, boolean promotion,boolean ruku,boolean chuku) {
        this.model = model;
        setPrice(model);
        promotionSetting.set(promotion);
        this.ruku.set(ruku);
